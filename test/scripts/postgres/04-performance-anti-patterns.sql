-- Performance anti-patterns: redundant indexes + slow query patterns (PostgreSQL)
-- Populates pg_stat_statements with query digest data
...
-- =============================================================================
-- Slow query patterns (populate pg_stat_statements)
-- =============================================================================
